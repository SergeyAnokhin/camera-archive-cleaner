...
// Single-image prompt for local Ollama models (e.g. gemma3:4b). Small models
// are unreliable at "N images -> array of N", so the backend loops one image
// per request with this prompt and format=json.
export const OLLAMA_SINGLE_IMAGE_TEMPLATE = `Ты анализируешь ОДИН снимок с камеры видеонаблюдения.

- description: 1-2 предложения. Опиши ДИНАМИЧЕСКИЕ объекты и их взаимодействие или положение. Фон и декорации не описывай.
- objects: массив коротких слов для динамических объектов. Используй максимально конкретные слова:
  • Люди: "мужчина", "женщина", "ребёнок", "мальчик", "девочка" — или "человек" если пол/возраст не определить.
  • Животные: "кошка", "собака", "птица", "курица", "кролик", "лиса", "белка" и т.д. — НЕ пиши просто "животное".
  • Транспорт: "машина", "грузовик", "велосипед", "мотоцикл", "автобус".
  • Прочее: "дождь", "снег", "паук", "пакет".
  Пустой массив [], если динамических объектов нет.
